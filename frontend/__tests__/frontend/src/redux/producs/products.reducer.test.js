...
import productsReducer from '../../../../../frontend/src/redux/producs/products.reducer';
import { ADD_PRODUCT, REMOVE_PRODUCT, UPDATE_PRODUCT } from '../../../../../frontend/src/redux/producs/products.actionTypes';
...
describe('productsReducer', () => {
    ...
    it('should handle ADD_PRODUCT action', () => {
        ...
        expect(returnedState.products).toContain(newProduct);
    });
    ...
    it('should handle REMOVE_PRODUCT action', () => {
        ...
        const returnedState = productsReducer(currentState, removeAction);
        expect(returnedState.products).toEqual([]);
    });
    ...
    it('should handle UPDATE_PRODUCT action', () => {
        ...
        const returnedState = productsReducer(currentState, updateAction);
        expect(returnedState.products[0]).toEqual(updatedProduct);
    });
});
